  ...
  return (
    <main style={{ padding: 24, display: "grid", gap: 16, maxWidth: 900 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <h1 style={{ fontSize: 22, fontWeight: 700 }}>Projeto #{projeto.id} — Editar</h1>
        <div style={{ display: "flex", gap: 8 }}>
          <a href={`/projetos/${projetoId}/itens`} style={linkBtn}>
            Orçamento (itens)
          </a>
      ...
      <section style={card}>
        ...
        <form action={atualizarProjeto} style={{ display: "grid", gap: 8, gridTemplateColumns: "2fr 1fr 1fr" }}>
          ...
          <input name="nome" defaultValue={projeto.nome} placeholder="Nome do projeto" required style={input} />
