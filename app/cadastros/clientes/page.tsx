...
export default async function Page() {
  ...
  return <ClientesPage me={me} clientes={clientes} />;
}

/* =====================
   COMPONENTE CLIENTES
===================== */
function ClientesPage({ me, clientes }: any) {
  ...
  async function handleCepChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (raw.length === 8) {
      ...
      try {
        ...
        if (!data.erro) {
          const full = `${data.logradouro || ""}, ${data.bairro || ""}, ${
            data.localidade || ""
          } - ${data.uf || ""}`;
          setEndereco(full);
        }
                  ...
                  <details style={{ display: "inline-block", marginRight: 8 }}>
                    ...
                    <div style={{ paddingTop: 8 }}>
                      ...
                      >
                        ...
                        <input name="cpf" defaultValue={c.cpf ?? ""} style={input} />
                        <input name="cnpj" defaultValue={c.cnpj ?? ""} style={input} />
                        <input name="email" defaultValue={c.email ?? ""} style={input} />
                        <input name="telefone" defaultValue={c.telefone ?? ""} style={input} />
                        <input
                          name="endereco"
