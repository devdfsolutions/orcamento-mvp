  ...
  return (
    <div className="mt-5">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {/* espaçamento claro entre botões e honorários */}
        <div className="w-px h-6 bg-neutral-200 mx-1" />

        <label className="text-sm text-neutral-600 flex items-center gap-2">
          Honorários (%)
          <input
            className="w-16 border rounded-md px-2 py-1 text-right text-sm"
            inputMode="decimal"
            placeholder="ex.: 10"
      ...
      {/* Pula linha entre toolbar e tabela */}
      <div className="mt-4" />
      ...
      <div className="overflow-x-auto rounded-lg border">
        <table
          ...
          style={{
            ...
            borderSpacing: '0 4px', // “gap” vertical entre as linhas
          }}
        >
                ...
                <tr key={r.id} className="bg-white">
                  ...
                  <td className="px-3 py-3 text-right align-middle">
                    <div className="flex items-center justify-end gap-1">
                      <input
                        className="w-12 border rounded-md px-1.5 py-1 text-right text-sm"
                        inputMode="decimal"
                        placeholder="%"
                        value={r.percentual ?? ''}
      ...
      {/* pula UMA LINHA entre tabela e totais */}
      <div className="mt-5" />

      {/* TOTAIS ------------------------------------------------- */}
      <div className="grid gap-1 text-sm">
        <div className="text-neutral-500">Fornecedores (base)</div>
        <div className="text-neutral-800">
          {baseTotal.toLocaleString('pt-BR', { style: 'currency', currency: 'BRL' })}
        </div>

        <div className="mt-2 text-neutral-500">Fornecedores (ajustado)</div>
        <div>
        ...
        <div className="mt-2 text-neutral-500">Com honorários (prévia)</div>
